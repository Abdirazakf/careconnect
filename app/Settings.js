...
const Settings = () => {
  ...
  return (
    <Box flex={1} bg={colorMode === 'dark' ? 'gray.800' : 'gray.50'} padding={moderateScale(10)} paddingTop={moderateScale(40)}>
      <Heading color={colorMode === 'dark' ? 'white' : 'black'} fontSize={moderateScale(20)} marginBottom={moderateScale(12)}>
        Settings
      </Heading>
